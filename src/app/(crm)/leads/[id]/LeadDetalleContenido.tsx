        ...
        <div className="rounded-3xl bg-slate-950/85 border border-slate-700 p-5 lg:col-span-2">
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            <button
              disabled={saving}
              onClick={() =>
                crearActividad("estado", "Revisión de estado", `Estado revisado: ${(lead.estado || "pendiente").toUpperCase()}`)
              }
            ...
            <button
              disabled={saving}
              onClick={() =>
                crearActividad("accion", "Seguimiento", `Seguimiento: ${lead.proximaAccion || "—"} · ${fmt(lead.proximaAccionEn)}`)
              }
